...
import { LayoutDashboard, ShoppingBag, LineChart, Boxes, UtensilsCrossed, Users, CalendarClock, QrCode, LogOut, Sparkles, Menu as MenuIcon, X, CreditCard, Megaphone, Info, AlertTriangle, LifeBuoy, ChefHat, Lightbulb, Palette, MessageSquareHeart } from "lucide-react";
...
const nav = [
  ...
  { href: "/admin/feedback", label: "Customer Feedback", icon: MessageSquareHeart, testid: "admin-nav-feedback" },
  { href: "/admin/marketing", label: "Marketing & QR", icon: Palette, testid: "admin-nav-marketing" },
